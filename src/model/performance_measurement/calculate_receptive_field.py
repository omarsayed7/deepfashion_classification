...
def receptive_field(model, input_size, batch_size=-1, device="cpu"):
    '''
    :parameter
    ...
    def register_hook(module):
        ...
        def hook(module, input, output):
            ...
            if not receptive_field["0"]["conv_stage"]:
                ...
                elif class_name == "BatchNorm2d" or class_name == "ReLU" or class_name == "SiLU" or class_name == "Sigmoid" or class_name == "Bottleneck" or class_name == "AdaptiveAvgPool2d" or class_name == "BatchNorm3d":
